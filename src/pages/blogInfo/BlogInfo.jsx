      ...
      <section className="rounded-lg h-full overflow-hidden max-w-4xl mx-auto px-4 ">
        <div className=" py-4 lg:py-8 ">
          {loading
            ...
            <div >
              {/* Thumbnail  */}
              <img alt="content" className="mb-3 border-2 border-black w-full h-full"
                src={getBlogs?.thumbnail}
              />
              {/* title And date  */}
              <div className="flex justify-between items-center mb-3">
                <h1 style={{ color: mode === 'dark' ? 'white' : 'black' }}
                  className=' text-xl md:text-2xl lg:text-xl font-bold font-avi'>
                  Title : {getBlogs?.blogs?.title}
                </h1>
                <p className='font-avi text-xs' style={{ color: mode === 'dark' ? 'white' : 'black' }}>
                 Posted On : {getBlogs?.date}
                </p>
              </div>
              <div
