...
export default function SearchDialog() {
    ...
    return (
        <Fragment>
            ...
            {/* Dialog  */}
            <Dialog className=" relative right-[1em]   md:right-0 md:w-0 lg:right-0 lg:w-0" open={open} handler={handleOpen} style={{ background: mode === 'light' ? '#2f3542' : '#2f3542', color: mode === 'dark' ? 'white' : 'black' }}>
                {/* Dialog Body  */}
                <DialogBody >
                    <h1 className="px-2 font-avi font-bold my-2">Search Articles</h1>
